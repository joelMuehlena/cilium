...
const (
	...
	// QoSPolicyName is the full name of the QOSPolicy CRD.
	QoSPolicyName = k8sconstv2alpha1.QoSPolicyKindDefinition + "/" + k8sconstv2alpha1.CustomResourceDefinitionVersion
)
...
func CustomResourceDefinitionList() map[string]*CRDList {
	return map[string]*CRDList{
		...
		synced.CRDResourceName(k8sconstv2alpha1.QoSPolicyName): {
			Name:     QoSPolicyName,
			FullName: k8sconstv2alpha1.QoSPolicyName,
		},
	}
}
